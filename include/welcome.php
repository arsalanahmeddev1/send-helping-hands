<section class="pt-100 pb-110 light-blue-bg">
    <div class="container-fluid">
        <div class="row align-items-lg-center">
            <div class="col-md-5">
                <div>
                    <img src="./assets/images/welocme-sec-img.png" class="mb-md-20" alt="">
                </div>
            </div>
            <div class="col-md-7">
                <div>
                    <h6 class="sec-title">WELCOME TO</h6>
                ...
                <div class="row">
                    <div class="col-6 col-sm-4  col-4">
